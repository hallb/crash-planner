...
**Generated:** 2026-03-10T00:56:41.542385+00:00
...
flowchart TD
  ...
  M2["M-2: Parameter tuning + perf…"]:::done
  M3["M-3: Config persistence + pause"]:::done
  M4["M-4: Flock metrics + agent…"]:::done
  M5["M-5: Agent follow + trail"]:::done
  M6["M-6: Flock2 + algorithm…"]:::done
  M7["M-7: 3D mode"]:::done
...
| M-5: Agent follow + trajectory trail | Completed | 9 / 11 | 4 | 2 |
...
| M-10: 3D camera controls | Planning | 0 / 9 | 2 | 0 |
...
|----|-------|----------|-----------|
| ISS-77 | Trail buffer overflow — segfault when drawing trajectory trail | Medium | M-5 |
| ISS-78 | Crash when switching to 3D after selecting bird with trail active | Medium | M-5 |
| ISS-79 | Follow (2D) — use centre-third dead zone; camera moves only when bird leaves it | Medium | M-10 |
| ISS-80 | Viewport follow does not work in 3D mode | Medium | M-10 |
